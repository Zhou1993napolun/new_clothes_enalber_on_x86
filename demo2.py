...
def main():
    ...
    print("The detector_pipeline is  :  ")
    print(detector_pipeline)
    ...
    while True:
        ...
        if results:
            ...
            if objects:
                out = detector_pipeline(frame)
                print("this is objects :  ")
                print(out)
