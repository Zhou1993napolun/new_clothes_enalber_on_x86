...
def main():
    ...
    while True:
        ...
        if results:
            ...
            if not args.no_show:
                ...
                cv2.imwrite("/home/ubuntu/hws/reid_pose/11_22_dir/temp_dress/{}.jpg".format(img_cnt), frame)
                img_cnt += 1
                print(img_cnt)
    ...
    print("Now, the next_frame_id_to_show is :  ", end='')
    print(next_frame_id_to_show)

    while detector_pipeline.has_completed_request():
        print("This happened !")
        print("The value of next_frame_id_to_show is :  ", end='')
        print(next_frame_id_to_show)
        results = detector_pipeline.get_result(next_frame_id_to_show)
        if results:
            objects, frame_meta = results
